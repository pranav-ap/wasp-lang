...
Bytecode_ptr BytecodeGenerator::execute(const Module_ptr module_ast)
{
	next_id = 0;
	next_label = 0;
	...
	Bytecode_ptr bytecode = make_shared<Bytecode>(instructions, constant_pool);
...
void BytecodeGenerator::visit(const Statement_ptr statement)
{
...
void BytecodeGenerator::visit(std::vector<Statement_ptr> const& block)
{
...
void BytecodeGenerator::visit(Assignment const& statement)
{
	visit(statement.expression);

	auto scope = scope_stack.top();
	int id = scope->symbol_table->lookup(statement.name);
	emit(OpCode::STORE_LOCAL, id);
}

void BytecodeGenerator::visit(Branching const& statement)
{
...
void BytecodeGenerator::visit(WhileLoop const& statement)
{
...
void BytecodeGenerator::visit(ForInLoop const& statement)
{
	...
	int item_id = next_id++;
	scope->symbol_table->define(statement.item_name, item_id);
...
void BytecodeGenerator::visit(Pass const& statement)
{
	emit(OpCode::NO_OP);
}

void BytecodeGenerator::visit(Break const& statement)
{
	auto scope = scope_stack.top();
	emit(OpCode::JUMP, scope->break_label);
}

void BytecodeGenerator::visit(Continue const& statement)
{
	auto scope = scope_stack.top();
	emit(OpCode::JUMP, scope->continue_label);
}

void BytecodeGenerator::visit(Return const& statement)
{
...
void BytecodeGenerator::visit(YieldStatement const& statement)
{
	if (statement.expression.has_value())
	{
		visit(statement.expression.value());
...
void BytecodeGenerator::visit(VariableDefinition const& statement)
{
	visit(statement.expression);
	...
	auto scope = scope_stack.top();
	scope->symbol_table->define(statement.name, id);

	emit(OpCode::STORE_LOCAL, id);
}

void BytecodeGenerator::visit(UDTDefinition const& statement)
{
}

void BytecodeGenerator::visit(AliasDefinition const& statement)
{
}

void BytecodeGenerator::visit(FunctionDefinition const& statement)
{
	enter_scope();
	...
	{
		auto scope = scope_stack.top();
		scope->symbol_table->define(statement.name, next_id++);
	}
...
void BytecodeGenerator::visit(GeneratorDefinition const& statement)
{
}

void BytecodeGenerator::visit(EnumDefinition const& statement)
{
}

void BytecodeGenerator::visit(ImportCustom const& statement)
{
}

void BytecodeGenerator::visit(ImportInBuilt const& statement)
{
}

void BytecodeGenerator::visit(ExpressionStatement const& statement)
{
	visit(statement.expression);
	emit(OpCode::POP_FROM_STACK);
}

void BytecodeGenerator::visit(AssertStatement const& statement)
{
	visit(statement.expression);
	emit(OpCode::ASSERT);
}
...
void BytecodeGenerator::visit(const Expression_ptr expression)
{
	std::visit(overloaded{
...
void BytecodeGenerator::visit(std::vector<Expression_ptr> const& expressions)
{
...
void BytecodeGenerator::visit(const double number)
{
...
void BytecodeGenerator::visit(const std::wstring text)
{
...
void BytecodeGenerator::visit(const bool boolean)
{
	if (boolean)
	{
...
void BytecodeGenerator::visit(ListLiteral const& expr)
{
	visit(expr.expressions);
	emit(OpCode::MAKE_LIST, expr.expressions.size());
}

void BytecodeGenerator::visit(TupleLiteral const& expr)
{
	visit(expr.expressions);
	emit(OpCode::MAKE_TUPLE, expr.expressions.size());
}

void BytecodeGenerator::visit(MapLiteral const& expr)
{
...
void BytecodeGenerator::visit(UDTConstruct const& expr)
{
}

void BytecodeGenerator::visit(UDTMemberAccess const& expr)
{
}

void BytecodeGenerator::visit(EnumMember const& expr)
{
}

void BytecodeGenerator::visit(Identifier const& expr)
{
	auto scope = scope_stack.top();
...
void BytecodeGenerator::visit(Call const& expr)
{
...
void BytecodeGenerator::visit(Unary const& expr)
{
	visit(expr.operand);
...
void BytecodeGenerator::visit(Binary const& expr)
{
	visit(expr.right);
	visit(expr.left);
...
Scope_ptr BytecodeGenerator::enter_scope()
{
...
Instructions BytecodeGenerator::leave_scope()
{
...
void BytecodeGenerator::emit(Instruction instruction)
{
	auto scope = scope_stack.top();
...
void BytecodeGenerator::emit(OpCode opcode)
{
	Instruction instruction = make_instruction(opcode);
	emit(instruction);
}

void BytecodeGenerator::emit(OpCode opcode, int operand)
{
	Instruction instruction = make_instruction(opcode, operand);
	emit(instruction);
}

void BytecodeGenerator::emit(OpCode opcode, int operand_1, int operand_2)
{
...
Instruction BytecodeGenerator::make_instruction(OpCode opcode)
{
...
Instruction BytecodeGenerator::make_instruction(OpCode opcode, int operand)
{
	Instruction instruction;
	instruction.push_back(static_cast<std::byte>(opcode));
...
Instruction BytecodeGenerator::make_instruction(OpCode opcode, int operand_1, int operand_2)
{
	Instruction instruction;
	instruction.push_back(static_cast<std::byte>(opcode));
...
int BytecodeGenerator::add_to_constant_pool(Object_ptr value)
{
	int id = next_id++;
...
int BytecodeGenerator::find_string_constant(wstring text)
{
...
int BytecodeGenerator::find_number_constant(int number)
{
	auto result = std::find_if(
		constant_pool.begin(),
		constant_pool.end(),
...
int BytecodeGenerator::create_label()
{
