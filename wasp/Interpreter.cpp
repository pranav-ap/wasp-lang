...
Object_ptr Evaluator::interpret(Statement_ptr statement)
{
...
Object_ptr Evaluator::interpret(Expression_ptr expression)
{
	return std::visit(overloaded{
...
Object_ptr Evaluator::interpret(VariableDefinition declaration)
{
...
Object_ptr Evaluator::interpret(Assignment assignment)
{
...
Object_ptr Evaluator::interpret(MultipleAssignment statement)
{
	ASSERT(
...
Object_ptr Evaluator::interpret(ConditionalBranch branch)
{
...
Object_ptr Evaluator::interpret(IfLetBranch statement)
{
	return Object_ptr();
}

Object_ptr Evaluator::interpret(InfiniteLoop loop)
{
...
Object_ptr Evaluator::interpret(ForEachLoop statement)
{
...
Object_ptr Evaluator::interpret(Break)
{
...
Object_ptr Evaluator::interpret(Continue)
{
	if (env->is_inside_loop_scope())
...
Object_ptr Evaluator::interpret(Return statement)
{
...
Object_ptr Evaluator::interpret(ExpressionStatement statement)
{
	return interpret(statement.expression);
}

Object_ptr Evaluator::interpret(UDTDefinition def)
{
	env->create_UDT(def.name, def.is_public, def.member_types);
	return VOID;
}

Object_ptr Evaluator::interpret(FunctionDefinition def)
{
...
Object_ptr Evaluator::interpret(EnumDefinition def)
{
...
Object_ptr Evaluator::interpret(ImportCustom statement)
{
	return VOID;
}

Object_ptr Evaluator::interpret(ImportInBuilt statement)
{
...
Object_ptr Evaluator::interpret(string string_literal)
{
	return MAKE_OBJECT_VARIANT(StringObject(string_literal));
}

Object_ptr Evaluator::interpret(double number_literal)
{
	return MAKE_OBJECT_VARIANT(NumberObject(number_literal));
}

Object_ptr Evaluator::interpret(bool bool_literal)
{
	return MAKE_OBJECT_VARIANT(BooleanObject(bool_literal));
}

Object_ptr Evaluator::interpret(VectorLiteral vector_literal)
{
...
Object_ptr Evaluator::interpret(DictionaryLiteral dict_literal)
{
...
Object_ptr Evaluator::interpret(Identifier expression)
{
	auto info = env->get_variable_info(expression.name);
	return move(info->value);
}

Object_ptr Evaluator::interpret(EnumMember expression)
{
...
Object_ptr Evaluator::interpret(Unary unary_expression)
{
...
Object_ptr Evaluator::interpret(Binary binary_expression)
{
...
Object_ptr Evaluator::interpret(MemberAccess access_expression)
{
...
Object_ptr Evaluator::interpret(FunctionCall call_expression)
{
...
Object_ptr Evaluator::loop_over_iterable(string item_name, Block block, DictionaryObject& dict_object)
{
...
bool Evaluator::are_same_type(Object_ptr obj, Type_ptr type)
{
	if (
...
Type_ptr Evaluator::get_object_type(Object_ptr object)
{
	return std::visit(overloaded{
