...
std::ostream& operator<<(std::ostream& os, const StringLiteral_ptr exp)
{
	os << " " << exp->value << " ";
	return os;
}

std::ostream& operator<<(std::ostream& os, const NumberLiteral_ptr exp)
{
	os << " " << exp->value << " ";
	return os;
}

std::ostream& operator<<(std::ostream& os, const BooleanLiteral_ptr exp)
{
	os << " " << exp->value << " ";
	return os;
}

std::ostream& operator<<(std::ostream& os, const VectorLiteral_ptr exp)
{
	os << " [ ";
...
std::ostream& operator<<(std::ostream& os, const UDTLiteral_ptr exp)
{
...
std::ostream& operator<<(std::ostream& os, const Identifier_ptr exp)
{
	os << exp->name;
	return os;
}

std::ostream& operator<<(std::ostream& os, const Unary_ptr exp)
{
	os << exp->op << exp->operand;
	return os;
}

std::ostream& operator<<(std::ostream& os, const Binary_ptr exp)
{
	os << exp->left << " " << exp->op << " " << exp->right;
	return os;
}

std::ostream& operator<<(std::ostream& os, const VectorMemberAccess_ptr exp)
{
	os << exp->name << "[" << exp->expression << "]";
	return os;
}

std::ostream& operator<<(std::ostream& os, const UDTMemberAccess_ptr exp)
{
	os << exp->UDT_name << "." << exp->member_name;
	return os;
}

std::ostream& operator<<(std::ostream& os, const EnumMemberAccess_ptr exp)
{
	os << exp->enum_name << "::" << exp->member_name;
	return os;
}

std::ostream& operator<<(std::ostream& os, const FunctionCall_ptr exp)
{
	os << "Call" << exp->name;
	return os;
}

std::ostream& operator<<(std::ostream& os, const Range_ptr exp)
{
